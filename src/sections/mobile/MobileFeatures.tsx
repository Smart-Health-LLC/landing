        ...
        <div className="flex flex-wrap items-center">
          <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-6 lg:mb-0 lg:w-5/12">
            ...
            >
              ...
              />
              <a href="#!">
                <div className="absolute inset-0 size-full overflow-hidden bg-[hsl(0,0%,0%,0.4)] bg-fixed">
                ...
                <div className="relative overflow-hidden bg-cover bg-no-repeat">
                  <div className="absolute inset-0 size-full overflow-hidden bg-[hsl(0,0%,98.4%,0.2)] bg-fixed opacity-0 transition duration-300 ease-in-out hover:opacity-100"></div>
                </div>
              </a>
            </div>
          </div>
